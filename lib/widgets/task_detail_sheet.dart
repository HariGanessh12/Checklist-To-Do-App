    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
            ...
            children: [
              Container(
                ...
                decoration: BoxDecoration(
                  color: Color(group?.colorValue ?? 0xFF6750A4).withValues(alpha: 0.1),
              ...
              Expanded(
                child: Column(
                  ...
                  children: [
                    ...
                    Text(group?.name ?? "Individual", style: TextStyle(color: Colors.grey.shade600)),
                  ],
                ),
              ),
          ...
          const Text("Schedule", style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey)),
          const SizedBox(height: 8),
          Row(
            children: [
              Icon(Icons.calendar_today_rounded, size: 18, color: isOverdue ? Colors.red : Colors.blue),
